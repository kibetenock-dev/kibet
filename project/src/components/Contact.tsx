          ...
          >
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-ink-800/60 border border-white/5 text-ink-100 placeholder-ink-500 text-sm focus:outline-none focus:border-accent-500/40 focus:ring-1 focus:ring-accent-500/20 transition-all"
                />
              </div>
              <div>
                <label className="block text-xs font-medium text-ink-400 mb-2 tracking-wide">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-xl bg-ink-800/60 border border-white/5 text-ink-100 placeholder-ink-500 text-sm focus:outline-none focus:border-accent-500/40 focus:ring-1 focus:ring-accent-500/20 transition-all resize-none"
              />
            </div>
            <button
              type="submit"
