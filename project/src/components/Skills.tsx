import { Code2, Database, Cloud, Terminal, Layers } from 'lucide-react';
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {cat.skills.map((skill) => (
                    <span
                      key={skill}
                      className="px-3 py-1 rounded-lg bg-ink-800/60 text-xs font-medium text-ink-300 border border-white/5 hover:border-accent-500/30 hover:text-accent-300 transition-colors"
                    >
                      {skill}
                    </span>
                  ))}
