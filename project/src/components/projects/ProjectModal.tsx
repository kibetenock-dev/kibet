...
export default function ProjectModal({ title, onClose, children }: ProjectModalProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative w-full max-w-3xl max-h-[90vh] overflow-y-auto glass rounded-2xl border-white/10"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="sticky top-0 z-10 flex items-center justify-between px-6 py-4 bg-ink-900/90 backdrop-blur-xl border-b border-white/5">
