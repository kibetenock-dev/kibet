    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 px-4 py-2.5 rounded-xl bg-ink-800/60 border border-white/5 text-ink-100 placeholder-ink-500 text-sm focus:outline-none focus:border-accent-500/40 transition-all"
        />
        <button
          onClick={addTodo}
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-xs font-medium capitalize transition-all ${
              filter === f
                ...
                : 'bg-ink-800/60 text-ink-400 border border-white/5 hover:text-ink-200'
            }`}
          >
            {f}
          </button>
      ...
      <div className="space-y-2">
        ...
        {filtered.map((todo) => (
          <div
            key={todo.id}
            className="group flex items-center gap-3 rounded-xl bg-ink-800/60 border border-white/5 px-4 py-3 hover:border-accent-500/20 transition-colors"
          >
            <button
