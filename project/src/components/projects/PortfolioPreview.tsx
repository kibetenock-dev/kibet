...
export default function PortfolioPreview() {
  return (
    <div className="space-y-6">
      ...
      {/* Mini hero */}
      <div className="text-center py-10 rounded-2xl bg-gradient-to-br from-accent-500/10 to-cyan-500/10 border border-white/5 relative overflow-hidden">
      ...
      {/* Mini about */}
      <div className="rounded-2xl bg-ink-800/40 border border-white/5 p-5">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-3">
          {['Todo App', 'Weather App', 'Quiz App', 'Calculator'].map((p) => (
            <div
              key={p}
              className="rounded-xl bg-ink-800/60 border border-white/5 p-4 hover:border-accent-500/20 transition-colors"
            >
