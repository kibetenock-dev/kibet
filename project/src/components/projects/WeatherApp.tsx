...
export default function WeatherApp() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-ink-800/60 border border-white/5 text-ink-100 placeholder-ink-500 text-sm focus:outline-none focus:border-accent-500/40 transition-all"
          />
        </div>
        <button
      ...
      {/* Weather card */}
      {weather && !loading && (
        <div className="rounded-2xl bg-gradient-to-br from-ink-800/80 to-ink-900/80 border border-white/5 p-6">
