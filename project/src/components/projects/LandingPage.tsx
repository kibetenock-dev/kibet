...
export default function LandingPage() {
  return (
    <div className="space-y-8">
      {/* Hero */}
      <div className="text-center py-8 rounded-2xl bg-gradient-to-br from-accent-500/10 to-cyan-500/10 border border-white/5">
      ...
      <div>
        ...
        <div className="grid sm:grid-cols-3 gap-3">
          {features.map((f) => (
            <div
              key={f.title}
              className="rounded-xl bg-ink-800/60 border border-white/5 p-4 text-center hover:border-accent-500/20 transition-colors"
            >
      ...
      {/* CTA */}
      <div className="text-center py-6 rounded-2xl bg-ink-800/40 border border-white/5">
